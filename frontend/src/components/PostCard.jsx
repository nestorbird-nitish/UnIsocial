...
export const PostCard = ({ post, user, isPersonalCard }) => {
    ...
    return (
        <div
            ...
            className="relative bg-white rounded-lg border border-gray-200 shadow-sm max-w-3xl mx-auto overflow-hidden cursor-pointer"
        >
            {/* Error Alert */}
            {error && (
            ...
            {/* Delete Button (if personal card) */}
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <button
                            ...
                            disabled={isLiking}
                            className="flex items-center space-x-2 transition-all duration-200 disabled:opacity-50 cursor-pointer"
                        >
                            <Heart
                                size={20}
                                className={`${isLiked ? 'fill-current text-red-500' : 'text-gray-600'}`}
                            />
